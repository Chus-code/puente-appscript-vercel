  ...
  try {
    ...
    const gasResponse = await fetch(GOOGLE_APPS_SCRIPT_URL, {
      ...
      headers: {
        ...
        // No necesitamos cabeceras de autenticación aquí si tu GAS está en "Cualquier usuario"
        // y confiamos en que Vercel no es bloqueado como App Inventor directamente.
      },
